...
class MemoryCell(torch.nn.Module):
    ...
    def forward(self, input_ids, memory_state=None, **kwargs):
        ...
        position_idx = [idx + self.num_mem_tokens for idx in input_idx]
        
        seg_kwargs = self.process_input(input_ids, memory_state, position_idx, **kwargs)
    ...
    def process_input(self, input_ids, memory_state, position_idx, **kwargs):
        ...
        seg_kwargs['position_idx'] = position_idx
        seg_kwargs['memory_size'] = self.num_mem_tokens
        return seg_kwargs
